...
results |> 
  ...
  mutate(
    home_cat = case_when(
      ...
      origin %in% c("Bromley", "Croydon", "Kingston upon Thames", "Merton", "Sutton", "Wandsworth") ~ "North",
    ...
    work_cat = case_when(
      ...
      destination %in% c("Bromley", "Croydon", "Kingston upon Thames", "Merton", "Sutton", "Wandsworth") ~ "North",
...
ggsave("disparity_origin.jpg", width = 9, height = 4)
```
